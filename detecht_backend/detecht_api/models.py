...
class Document(models.Model):
    ...
    file = models.FileField(upload_to='detecht_api/static/pdf', max_length=100,
                            blank=True)
    ...
    def delete(inputName):
        ...
        Document.objects.filter(title=str(inputName)).delete()  # This part is
        # deleting the row in db.
        return


# table for staged pdfs to be converted to Json format and added to elastic
# search
...
class Keyword_distance(models.Model):
    ...
    # Can take max 1 digit (0 or 1) and 4 decimals. eg 1.1234

    class Meta:
        unique_together = ("id_1", "id_2")  # Django doesn't support
        # multiple pk, so this is the solution.
