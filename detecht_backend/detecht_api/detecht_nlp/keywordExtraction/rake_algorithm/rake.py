# Implementation of rake_algorithm - Rapid Automatic Keyword Extraction algorithm
# as described in:
...
if test and __name__ == '__main__':
    text = "Compatibility of systems of linear constraints over the set of natural numbers. Criteria of compatibility " \
           ...
           "considered. Upper bounds for components of a minimal set of solutions and algorithms of construction of " \
           "minimal generating sets of solutions for all types of systems are given. These criteria and the " \
           "corresponding algorithms for constructing a minimal supporting set of solutions can be used in solving " \
