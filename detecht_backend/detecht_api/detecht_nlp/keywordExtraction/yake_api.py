...
Campos, R., Mangaravite, V., Pasquali, A., Jatowt, A., Jorge, A., Nunes,
C. and Jatowt, A. (2020). YAKE! Keyword Extraction from Single Documents
using Multiple Local Features. In Information Sciences Journal. Elsevier,
...
Advances in Information Retrieval. ECIR 2018 (Grenoble, France. March 26 –
29). Lecture Notes in Computer Science, vol 10772, pp. 684 - 691. pdf

Campos R., Mangaravite V., Pasquali A., Jorge A.M., Nunes C., and Jatowt A.
(2018). YAKE! Collection-independent Automatic Keyword Extractor. In: Pasi
G., Piwowarski B., Azzopardi L., Hanbury A. (eds). Advances in Information
...
if __name__ == '__main__':
    text = (
        ...
        "about the amount of code written for Python 2, support for Python "
        "2.7 (the last release in the 2.x series) was extended to 2020. "
        "Language developer Guido van Rossum shouldered sole responsibility "
        "for the project until July 2018 but now shares his leadership as a "
        "member of a five-person steering council.[30][31][32]\n "
        "\n"
        "The Python 2 language, i.e. Python 2.7.x, is \"sunsetting\" on "
        "January 1, 2020, and the Python team of volunteers will not fix "
        "security issues, or improve it in other ways after that date."
        "[33][34] With the end-of-life, only Python 3.6.x and later, e.g. "
        "Python 3.8 which should be released in October 2019 (currently in "
        "beta), will be supported.[35]\n "
        "\n"
        "Python interpreters are available for many operating systems. A "
        "global community of programmers develops and maintains CPython, "
        "an open source[36] reference implementation. A non-profit "
