...
document1 = "To Sherlock Holmes she is always the woman. I have seldom " \
            ...
            "that he felt any emotion akin to love for Irene Adler. All " \
            "emotions, and that one particularly, were abhorrent to his " \
            ...
            "save with a gibe and a sneer. They were admirable things for " \
            "the observer--excellent for drawing the veil from men's " \
            "motives and actions. But for the trained reasoner to admit " \
            "such intrusions into his own delicate and finely adjusted " \
            ...
            "a nature such as his. And yet there was but one woman to " \
            ...
            "happiness, and the home-centred interests which rise up around " \
            "the man who first finds himself master of his own " \
            ...
            "companion. One night--it was on the twentieth of March, " \
            "1888--I was returning from a journey to a patient (for I had " \
            "now returned to civil practice), when my way led me through " \
            "Baker Street. As I passed the well-remembered door, which must " \
