...
'''
@author: Edward
@file: test_textRank.py
@time: 2019/10/4 14:28
@desc: test the keyword extraction using textRank algorithm
'''

from detecht_api.detecht_nlp.keywordExtraction.text_Rank import *
